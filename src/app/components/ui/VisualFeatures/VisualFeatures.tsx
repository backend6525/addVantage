            ...
            <div className="custom-screen text-gray-300">
                <div className="max-w-xl mx-auto text-center">
                    <h2 className="text-gray-50 text-3xl font-semibold sm:text-4xl">
                        addVantage reimagining digital marketing 
                    </h2>
                    <p className="mt-3">
                    Direct Sales, Bigger Rewards: 
                    If someone within your network directly purchases a product or service through your shared ad, 
                    you earn an even larger commission!.
                    </p>
                </div>
                <div className="mt-12">
