...
// const columnColors = {
// 	[TaskStatus.WISHLIST]: 'bg-gray-50 hover:bg-gray-100',
// 	[TaskStatus.REQUESTED]: 'bg-blue-50 hover:bg-blue-100',
// 	[TaskStatus.OUTLINE]: 'bg-yellow-50 hover:bg-yellow-100',
// 	[TaskStatus.CREATION]: 'bg-green-50 hover:bg-green-100',
// 	[TaskStatus.FIRST_UPDATE]: 'bg-purple-50 hover:bg-purple-100',
// 	[TaskStatus.REVIEW]: 'bg-pink-50 hover:bg-pink-100',
// };
...
// 		return (
// 			<div
// 				className={`rounded-lg p-4 min-h-[600px] shadow-sm transition-colors duration-200 ${columnColors[status]}`}
...
// 						<PlusCircle className='h-5 w-5 text-gray-500 hover:text-purple-600' />
// 					</button>
// 				</div>
