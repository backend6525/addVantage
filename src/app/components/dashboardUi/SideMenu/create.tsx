...
// 			if (!res.ok) {
// 				const errorText = await res.text(); // Detailed error message
...
// 	const handleCreateAd = async () => {
// 		try {
// 			// Ensure only one request is sent by setting a flag
// 			if (!isFormValid()) {
...
// 				costPerView: formData.costPerView,
// 				numberOfDaysRunning: formData.numberOfDaysRunning,
// 				adResourceUrl: fileUrl || '', // Ensure fileUrl is included or empty
// 			};
