...
export const PublishedAdsTab = ({
	...
	// Get filtered ads based on selection
		...
		<div className='space-y-6'>
			...
			<div className='flex items-center gap-4'>
				...
				<Select value={selectedCategory} onValueChange={setSelectedCategory}>
					<SelectTrigger className='w-[160px] bg-slate-800/70 border-slate-700/50'>
						<SelectValue>
							<div className='flex items-center gap-2'>
								{selectedCategory === 'video' && <Video className='w-4 h-4' />}
								...
								{selectedCategory === 'poster' && 'Poster'}
					...
					<SelectContent>
						<SelectItem value='all'>
							<div className='flex items-center gap-2'>
								<ImageIcon className='w-4 h-4' />
								All ({publishedAds.length})
							</div>
						</SelectItem>
						<SelectItem value='poster'>
							<div className='flex items-center gap-2'>
								<ImageIcon className='w-4 h-4' />
								Poster ({posterAds.length})
							</div>
						</SelectItem>
				...
				{filteredAds.length > 0 ? (
								...
								<div className='relative mb-4 rounded-lg overflow-hidden'>
									{product.type === 'video' ? (
										...
										<div
											...
											className='relative bg-gradient-to-br from-slate-700/30 to-slate-800/30 aspect-square'>
					...
					<motion.div
						...
						<p className='text-gray-400'>
							No published {selectedCategory === 'all' ? '' : selectedCategory}{' '}
							ads found
						</p>
					</motion.div>
				)}
